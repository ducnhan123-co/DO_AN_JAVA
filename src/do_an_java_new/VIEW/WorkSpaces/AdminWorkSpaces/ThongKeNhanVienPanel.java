 ...
 * @author ASUS-PC
 */
public class ThongKeNhanVienPanel extends javax.swing.JPanel {
    ...
    private void renderTable(Date begin, Date end) {
        ...
        try {
            for (Object[] thongKe: NhanVienBLL.thongKeNhanVien(begin, end)) {
...
//            }
    ...
    private void initComponents() {
        ...
        tbCount.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã", "Họ", "Tên", "Số lượng hoá đơn", "Tổng số tiền"
            }
        ));
